    ...
    <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <tr><button style='margin-left:85%' class="btn btn-success btn-lg active" 
                                    onclick="location.href ='form_router.php?';">
                                    <span class='fas fa-bus'>&nbsp;&nbsp;+เพิ่มเส้นทาง</span> </button></tr>&nbsp;
            </div>
            <br>
                ...
                <div class="col-md-10">
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="">
                                    <thead>
                                        ...
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;">หมายเลขที่</th>
                                    ...
                                    <tbody>
                                        ...
                                        ดู
                                                ...
                                                <td>
                                                   ...
                                                   <a class="btn btn-info btn-sm"onclick="location.href ='edit_router.php?R_ID=<?=$row['R_ID']?>';">
                                                  <i class="fas fa-pencil-alt">
                                                  </i>
                                                  Edit
                                                   </a>

                                                  <a class="btn btn-danger btn-sm" onclick="location.href ='delete_router.php?R_ID=<?=$row['R_ID']?>';">
