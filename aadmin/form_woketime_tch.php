        ...
        <div class="card card-primary card-outline">
          ...
          <div class="row">
                ...
                <div class="col-md-10">
                  ...
                  <form role="form" action="into_work_tch.php"  >
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select autocomplete="off" type="text" id="inputIsValid " name="txttchid" autocomplete="off"
                        class="form-control" required>
                                 ...
                                 ?>
                                        <option value="<?php echo $row["TCH_ID"] ?>"><?php echo $row["TCH_ID"] ?>|<?php echo $row["T_NAME"] ?> 
                                            <?php echo $row["T_LNAME"] ?> </option>
                                        <?php
                                        }
                                    } else {
                                    }
