      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
          <div class="card-header">
            <h3 class="card-title">------การลงทะเบียนคนขับรถ-------</h3>
          </div> <!-- /.card-body -->
          ...
          <div class="row">
                ...
                <div class="col-md-10">
                  ...
                  <form role="form" action="intodriver.php" enctype="multipart/form-data"  >
                  <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label>รหัสคนขับรถ
                        <input type="text" class="form-control" id="inputstd_id" name="txtdrv_id" required="required" placeholder="Enter ..."></label>
                    ...
                    <div class="form-group">
                       <label>เลขประจำตัวประชาชน
                        ...
                        <input type="text" class="form-control" id="inputnumber" name="txtid_licen" required="required" placeholder="Enter ..."></label>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <option value="" required="required"selected>--------- เลือก ---------</option>
                  ...
                  <div class="custom-file">
                      ...
                      <input type="file" name="P_DRV" id="p_img" class="form-control" required="required" />
                </div>
              </div>
