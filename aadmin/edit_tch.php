      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
          ...
          <div class="row">
                ...
                <form method="post" action="update_tch.php?ID=<?php echo $TCH_ID; ?>"enctype="multipart/form-data" name="edit_tch.php">
                   ...
                   <div class="row">
                    <div class="col-sm-6"><!-- text input -->
                      <div class="form-group">
                        <label >ชื่อ
                        <input type="text" class="form-control" id="inputname" name="F_NAME"  value="<?=$rows['T_NAME']?>" placeholder="Enter ..."></label>
                      <label for="inputlasname" >สกุล
                        <input type="text" class="form-control" id="inputlname" name="LNAME" value="<?=$rows['T_LNAME']?>" placeholder="Enter ..."></label>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  id="inputphone" name="PHONE" value="<?=$rows['T_PHONE']?>" placeholder="...ถ้ามี...">
                      </div>
                    </div>
