      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
          ...
          <div class="row">
                ...
                <form method="post" action="update_show_tch.php?ID=<?php echo $TCH_ID; ?>" name="edit_show_tch.php">
...
<br>
                  ...
                  <div class="custom-file">
                      ...
                      <input type="file" class="form-control" name="P_TCH" id="mc_img" onchange="" value="<?=$rows['P_TCH']?>"/><br>
