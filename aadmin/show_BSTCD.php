    ...
    <body>
        ...
        <?php
            ...
            <div class="jumbotron" >
              ...
              <a  class="btn btn-info btn-sm" onclick="location.href ='table_bus_STCD.php?';">
        <i > <<-back
        </i></a>
...
<center> 
           ...
           <tr><td align="center" style="width:20%;" ><label for="BRAND" class="b"><b style="color:black">ยี่ห้อ : </b>
            ...
            <td align="center" style="width:20%;" ><label for="COLOR" class="b"><b style="color:black" >ที่นั่ง : </b> 
            <?php echo $result["B_num"];?> </label> <br></td></tr>
     ...
     ?>   
        ...
        ?>   
           ...
           <tr><td align="center"  ><label  class="b"><b style="color:black">ครูประจำรถ : </b>
            ...
            <?php echo $result["T_NAME"];?> <?php echo $result["T_LNAME"];?></label> 
