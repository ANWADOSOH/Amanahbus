    ...
    <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">ตารางเเสดงข้อมูลคนขับรถ</h3>
              <tr><button style='margin-left:70%' class="btn btn-success btn-lg active" 
                                    onclick="location.href ='fromdriver.php?';">
                ...
                <div class="col-md-10">
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="">
                                    <thead>
                                        ...
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;">รหัสคนขับรถ</th>
                                            <th  tabindex="0" rowspan="1" colspan="1" style="width: 10%;">ชื่อ-สกุล</th>
                                            <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;">เพศ</th>
                                            <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;">เลขที่ใบขับขี่</th>
                                        ...
                                        if ($result->num_rows > 0) {
                                          $i=1;
                                            while ($row = $result->fetch_assoc()) { ?>
                                              ...
                                              <td>
                                              <a class="btn btn-primary btn-sm" onclick="location.href ='show_driver.php?DRV_ID=<?=$row['DRV_ID']?>';">
                                                  <i class="fas fa-folder">
                                                  </i>
                                                  View
                                                   </a>

                                                  <a class="btn btn-info btn-sm"onclick="location.href ='edit_driver.php?DRV_ID=<?=$row['DRV_ID']?>';">
                                                  <i class="fas fa-pencil-alt">
                                                  </i>
                                                  Edit
                                                   </a>

                                                  <a class="btn btn-danger btn-sm" onclick="location.href ='delete_driver.php?DRV_ID=<?=$row['DRV_ID']?>';">
