...
$result = $conn->query($sql);?>
    ...
    <section class="content-header">
      ...
      <br> 
       ...
       <a  class="btn btn-info btn-sm" onclick="location.href ='index7.php?';">
        <i > <<-back
        </i></a>
    ...
    <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              <h3  class="card-title">บันทึกค่าตอบเเทนครูประจำรถ</h3>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?php echo $row["P_TCH"] ?>" width="35" height="35"/></td>
                                                    
                                                    
                                              <td>
            

                                                  <a class="btn btn-info btn-sm"onclick="location.href ='fromesalarytch.php?TCH_ID=<?=$row['TCH_ID']?>';">
