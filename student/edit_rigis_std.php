...
<?php
 ...
 <section class="content-header">
      ...
      <br>
        ...
        <tr><button class="btn btn-success btn-lg active" onclick="location.href ='user_table_rigis_std.php?';">
      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
          ...
          <div class="row">
                ...
                <form method="post" action="update_rigis_std.php?ID=<?php echo $rigis_ID; ?>" name="edit_rigis_std.php">
