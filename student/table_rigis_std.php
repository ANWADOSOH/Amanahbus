                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="" >
                                    <thead>
                                        ...
                                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 3%;">ลำดับที่</th>
                                            <th  tabindex="0" rowspan="1" colspan="1" style="width: 1%;">รหัสนักเรียน</th>
                                            <th  tabindex="0" rowspan="1" colspan="1" style="width: 20%;">รหัสรถ</th>
                                            <th  tabindex="0" rowspan="1" colspan="1" style="width: 20%;">ปีการศึกษา</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM registration limit {$start} , {$perpage}";
