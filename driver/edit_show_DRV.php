      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
          ...
          <div class="row">
                ...
                <form method="post" action="update_show_DRV.php?ID=<?php echo $DRV_ID; ?>" enctype="multipart/form-data" name="edit_show_DRV.php">
                   ...
                   <div class="row">
                    <div class="col-sm-6"><!-- text input -->
                      <div class="form-group">
                        <label >ชื่อ
                        <input type="text" class="form-control" id="inputname" name="D_NAME"  value="<?=$rows['D_NAME']?>" placeholder="Enter ..."></label>
                      <label for="inputlasname" >สกุล
                        <input type="text" class="form-control" id="inputlname" name="D_LNAME" value="<?=$rows['D_LNAME']?>" placeholder="Enter ..."></label>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputnumber" name="LICEN_ID" value="<?=$rows['LICEN_ID']?>" placeholder="Enter ...">
                      </div>
                    </div>
