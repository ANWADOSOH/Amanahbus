...
<center>   <font size="4">
          ...
          <tr><br> <td align="center" style="width:25%;" ><br><label  for="TCH_ID" class="b"><b style="color:black">รหัสคครูประจำรถ : </b> 
           ...
           <label for="LNAME" class="b">
            ...
            <tr><td align="center" style="width:20%;" ><label for="T_PHONE" class="b"><b style="color:black">เบอร์ติดต่อ :</b>
