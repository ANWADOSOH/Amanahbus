...
<?php include("user_header1.php"); $sql = "SELECT * FROM bus";
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="">
                                    <thead>
                                        <tr role="row" class="info">
                                            ...
                                            <th  tabindex="0" rowspan="1" colspan="1" style="width: 15%;">ข้อมูลเพิ่มเติม</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM bus limit {$start} , {$perpage}";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-primary btn-sm" onclick="location.href ='show_BSTCD.php?BUS_ID=<?=$row['BUS_ID']?>';">
